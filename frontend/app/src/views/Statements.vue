  ...
  <div>
    ...
    <v-container fluid class="mt-4">
      ...
      ></v-select>
        ...
        <div class="mt-4">
          <v-btn color="primary" class="mr-2" @click="clockIn" :disabled="!selectedEmployeeClock">
            Clock In
          </v-btn>
          <v-btn color="secondary" class="mr-2" @click="clockOut" :disabled="!selectedEmployeeClock">
            Clock Out
          </v-btn>
          <v-btn color="warning" class="mr-2" @click="startLunch" :disabled="!selectedEmployeeClock">
            Start Lunch
          </v-btn>
          <v-btn color="success" @click="endLunch" :disabled="!selectedEmployeeClock">
            End Lunch
          </v-btn>
        </div>
      </div>
      ...
      <div v-if="currentSection === 'reports'">
        ...
        <v-row dense>
          ...
          <v-col cols="12" md="3" class="text-right">
            <v-btn color="primary" @click="generateAttendanceReport">Generate Report</v-btn>
          </v-col>
        </v-row>
        ...
        <div class="mt-4">
          <div v-if="reportResult">
            ...
            <p><strong>Total Hours Worked:</strong> {{ formatHours(reportResult.total_hours_worked) }}</p>
          </div>
        </div>
      </div>
      ...
      <div v-if="currentSection === 'leaveManagement'">
        ...
        <v-form ref="leaveForm">
          <v-row dense>
            ...
            <v-col cols="12" class="text-right">
              <v-btn color="primary" @click="submitLeaveRequest">Submit Leave Request</v-btn>
            </v-col>
          </v-row>
        </v-form>
            ...
            <tr v-for="(request, index) in items" :key="index">
              ...
              <td>
                <div v-if="request.status === 'Pending'">
                  <v-btn color="success" small @click="updateLeaveRequestStatus(request.leave_id, 'Approved')">
                    Approve
                  </v-btn>
                  <v-btn color="error" small @click="updateLeaveRequestStatus(request.leave_id, 'Rejected')">
                    Reject
                  </v-btn>
                </div>
              </td>
